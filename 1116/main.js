...
const texture = new THREE.TextureLoader().load( "green.jpg" );
...
let uniformData = {
  ...
  u_tex0Resolution: {type: "v2", value: new THREE.Vector2(4000/2, 2790/2)},
  u_logo:{type: "sampler2D", value:texture},
  logoResolution: {type: "v2", value: new THREE.Vector2(4000/2, 2790/2)},
